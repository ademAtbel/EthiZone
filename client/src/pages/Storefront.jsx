  ...
  if (error || !store) {
    ...
    return (
      <div className="container storefront-page flex-center" style={{ minHeight: '60vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div className="glass-panel shadow-sm" style={{ padding: '40px 30px', maxWidth: '500px', textAlign: 'center', borderRadius: '16px', border: '1px dashed var(--border-glass)', backgroundColor: 'var(--bg-card)', color: 'var(--text-main)' }}>
          <span style={{ fontSize: '3rem', display: 'block', marginBottom: '20px' }}>🛠️</span>
          <h3 style={{ fontSize: '1.4rem', fontWeight: '700', marginBottom: '10px', color: 'var(--text-main)' }}>Store Under Maintenance</h3>
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: '1.6', margin: 0 }}>{displayMessage}</p>
        </div>
      </div>
    );
  }
